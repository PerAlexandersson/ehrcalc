...
and three state-limited cases, again with no fresh closure. Both remote queues
were idle and the selector again returned zero fresh targets immediately before
sole host v182 began: the bounded, nice-10 CPU-15 grow/flag pass uses seed
`202609130182` (eight new exact-case cap, 6M states/360 seconds each,
1000-second outer limit).
