...
- Laplace v24 `20260913T081922-f2886ff50550` is fetched, provenance-verified,
  ...
  its 280-second d15 retry. The sole host writer now interpolates the final
  unresolved v2 signed-end lead `06793194...` under the same 60-second/
  290-second bounds; only a negative full result activates independent
  out-of-range replay. The legacy Abacus
