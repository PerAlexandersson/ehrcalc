...
- Laplace v24 `20260913T081922-f2886ff50550` is fetched, provenance-verified,
  ...
  now resumes the same v2 paired screen's 1,844 deferred proposals under the
  same three-count/6M-state/60-second/290-second bounds, skipping terminal
  identities; only a negative full result activates independent out-of-range
  replay. The legacy Abacus
