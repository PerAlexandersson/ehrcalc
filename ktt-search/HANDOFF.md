...
- Codex remains the sole private KTT worker and MariaDB writer; the exact
  ...
  exact-positive (3,515,148 states, 176.730 s); five d132--d133 one-hole
  screens are exact-negative (11,683,166--12,720,998 states,
  664.858--924.744 s), recorded as control-backed unreplayed discovery
  evidence, ledger `19dff7ea...`; the two canonical zero-hole closures of
  `468172...` are positive (`061cce...`, `25111b...`,
  `9ffa7a...`, `ac61fc...`), 30M states/1200 s each, 1500-s outer. Inputs
